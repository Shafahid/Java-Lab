...
public class CDPLAYER {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter 1 to play the song or 2 to get the information about the song: \n");

        System.out.println("1. Play the song\n2. Get information about the song \n");
            ...
            if (str.equals("Audio")) {
                if (n == 1) {
                    if(a.songs[0].getTitle().contains(".mp3")){
                        a.mp3player(a.songs[0].getTitle(), a.songs[0]);
                    } else if(a.songs[0].getTitle().contains(".wav")){
                        a.wavplayer(a.songs[0].getTitle(), a.songs[0]);
                    } else if(a.songs[0].getTitle().contains(".AAC")){
                        a.AACplayer(a.songs[0].getTitle(), a.songs[0]);
                    }
                } else if (n == 2) {
                    if(a.songs[1].getTitle().contains(".mp3")){
                        a.mp3player(a.songs[1].getTitle(), a.songs[1]);
                    } else if(a.songs[1].getTitle().contains(".wav")){
                        a.wavplayer(a.songs[1].getTitle(), a.songs[1]);
                    } else if(a.songs[1].getTitle().contains(".AAC")){
                        a.AACplayer(a.songs[1].getTitle(), a.songs[1]);
                    }
                } else if (n == 3) {
                    if(a.songs[2].getTitle().contains(".mp3")){
                        a.mp3player(a.songs[2].getTitle(), a.songs[2]);
                    } else if(a.songs[2].getTitle().contains(".wav")){
                        a.wavplayer(a.songs[2].getTitle(), a.songs[2]);
                    } else if(a.songs[2].getTitle().contains(".AAC")){
                        a.AACplayer(a.songs[2].getTitle(), a.songs[2]);
                    }
                } 
                ...
                if (n == 1) {
                    if(v.songs[0].getTitle().contains(".mp4")){
                        v.mp4player(v.songs[0].getTitle(), v.songs[0]);
                    } else if(v.songs[0].getTitle().contains(".avi")){
                        v.aviplayer(v.songs[0].getTitle(), v.songs[0]);
                    } else if(v.songs[0].getTitle().contains(".mkv")){
                        v.mkvplayer(v.songs[0].getTitle(), v.songs[0]);
                    }
                } else if (n == 2) {
                    if(v.songs[1].getTitle().contains(".mp4")){
                        v.mp4player(v.songs[1].getTitle(), v.songs[1]);
                    } else if(v.songs[1].getTitle().contains(".avi")){
                        v.aviplayer(v.songs[1].getTitle(), v.songs[1]);
                    } else if(v.songs[1].getTitle().contains(".mkv")){
                        v.mkvplayer(v.songs[1].getTitle(), v.songs[1]);
                    }
                } else if (n == 3) {
                    if(v.songs[2].getTitle().contains(".mp4")){
                        v.mp4player(v.songs[2].getTitle(), v.songs[2]);
                    } else if(v.songs[2].getTitle().contains(".avi")){
                        v.aviplayer(v.songs[2].getTitle(), v.songs[2]);
                    } else if(v.songs[2].getTitle().contains(".mkv")){
                        v.mkvplayer(v.songs[2].getTitle(), v.songs[2]);
                    }
                }
...
class Screen{
    ...
    void displayInfoPrompt(Song song) {
        System.out.println("To know more about the song, enter 1: \n");
        Scanner sc = new Scanner(System.in);
        int n = sc.nextInt();
